...
{\small
  ...
  % \faTwitter  \hspace{1em} \url{@Fred_Moser}\hfilly
...
\begin{multicols}{2}
  ...
  \dl{ % --------------{ Expériences FR }--------------- %
    ...
    \begin{cvPrint}
     % --------------{ WHO 1 }--------------- % 
    \cvEntry{11/2014 -- today}{Consultant en géomatque}{Organisation mondiale de la santé}{Genève}{
    Applicaiton géomatique pour l'évaluation de l'accessibilité physique aux réseaux de soins et modélisation de la couverture des soins à la population: \texttt{AccessMod 5}.
    }
      % --------------{ LEBA 2 }--------------- %
...
%          \end{itemize}}
    ...
    \begin{cvPrint}  
     % --------------{ WHO 1 }--------------- % 
    \cvEntry{11/2014 -- today}{GIS consultant}{World Health Organisation (60\%-100\%)}{Geneva}{
    Development of a standalone GIS application for physical accessibility to health care and population coverage modeling : \texttt{accessmod 5.0}.
    }
      % --------------{ LEBA 2 }--------------- %
      \cvEntry{03/2014 -- 06/2014}{Research assistant }{University of Geneva (50\%-100\%)}{Geneva}{
      ...
      % --------------{ LEBA 1 }--------------- %
      \cvEntry{08/2013--12/2013}{Research assistant}{University of Geneva (50\%)}{Geneva}{
...
%            \item Development of a set of functions and scripts\footnote{\texttt{smodiv} (\textit{Stat. pred. modeling of discharge in Valais}).} to automate statistical predictions of discharge for multiple hydrological stations, from simulated rainfall and glacial mass balance data for the 1951 to 2050 period;
  ...
  \begin{cvPrint}
    ...
    \dl{
      \cvEntry{06/2006--07/2006}{Service civil}{Genève Roule (100\%)}{Genève}{
      ...
      \cvEntry{06/2006--07/2006}{Service civil}{Genève Roule (100\%)}{Geneva}{
    ...
    \dl{
      \cvEntry{05/2005--08/2005}{Service civil}{Institut d'architecture et d'urbanisme de l'Université de Genève (100\%)}{Carouge}{

...
\begin{multicols}{2}
  ...
  \dl{% --------------{ Expériences FR }--------------- %
    ...
    \begin{cvPrint}
      % --------------{ unep/oms }--------------- %
      \cvEntry{06/2015 -- today }{Developer}{University of Geneva}{Geneva}{%
        Full stack developer of \texttt{MapX}, an open source web application for interactive mapping \\ 
        \url{https://app.mapx.org}.
      }
      \cvEntry{11/2014 -- today }{Developer}{University of Geneva}{Geneva}{%
        Full stack developer of \texttt{AccessMod~5}, a multiplatform desktop application for physical accessibility modelling \\ 
      ...
      \cvEntry{03/2014 -- 06/2014}{Research assistant}{University of Geneva}{Geneva}{%
        ...
        {\begin{itemize}
              \small
            \item Large spatial database processing (>2TB)
            \item Statistics on hourly flow for 60 years and 3000 Km of river 
  
            \item Development of an interactive web application\footnote{\texttt{lebamod} (\textit{Laboratoire d'écologie aquatique: modélisation de distribution d'espèces).} \url{http://sdm.unige.ch/} } using HPC in backend to create, fit, analyse and share a potentially large ensemble of predictive models and predictions;
          \end{itemize}}
      }
      % --------------{ LEBA 1 }--------------- %
  ...
  \dl{% --------------{ Formation FR }--------------- %
    ...
    \begin{cvPrint}
      \cvEntry{2010--2013}{Master of Environmental Sciences}{University of Geneva}{Genève}{%
        Thesis : \textsl{Impact of climatic changes on alpine biodiversity: species distribution modelling for aquatic insect in Rhône watershed in Valais.} \\
        {\footnotesize Direction : D\up{r} E. Castella \& Prof. D\up{r} A. Lehmann. }
      }
  ...
  \begin{multicols}{2}
    ...
    \noindent\begin{tabular}{ll}
      ...
      \score{3}{5} &\texttt{Mapbox GL (js)} \\
      \score{3}{5} &\texttt{Webpack (js)} \\
      %\score{3}{5} &\texttt{Docker} \\
  ...
  \begin{cvPrint}
    \dl{%
      ...
      \cvEntry{2000--2001}{Diploma of watchmaker \textsl{rhabilleur}}{School of watchmaking}{Petit-Lancy}{%
    ...
    \dl{%
      ...
      \cvEntry{1997--2000}{Diploma of watchmaker \textsl{praticien}}{Patek Philippe Geneva \\ \& School of watchmaking}{Plan-les-Ouates}{}
    }
    %\dl{%

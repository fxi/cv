...
\begin{multicols}{2}
  ...
  \dl{% --------------{ Formation FR }--------------- %
    ...
    \begin{cvPrint}
      \cvEntry{2010--2013}{Master en Sciences de l'Environnement}{Université de Genève}{Genève}{
        Mémoire: \textit{Changements climatiques et biodiversité alpine: modélisation de la distribution d'insectes aquatiques dans le bassin du Rhône en Valais.}\\
        {\footnotesize Direction : D\up{r} E. Castella \& Prof. D\up{r} A. Lehman. }
      }
      \cvEntry{2007--2010}{Bachelor en Géographie et Environnement}{Université de Genève}{Genève}{
        Mémoire: \textit{L'espace partagé comme solution pour reconsidérer la rue à échelle humaine.} \\
  ...
  \dl{
    ...
    Evaluation indicative\footnote{Echelle: \score{1}{5} = basic, \score{5}{5} = advanced} :
  }{
  ...
  \dl{ % --------------{ Expériences FR }--------------- %
    ...
    \begin{cvPrint}
      % --------------{ LEBA 2 }--------------- %
      \cvEntry{03/2013--5/2014}{Assistant de recherche}{Université de Genève}{Genève}{
      ...
      % --------------{ LEBA 1 }--------------- %
      \cvEntry{08/2013--12/2013}{Assistant}{Université de Genève (50\%)}{Genève}{
  ...
  \begin{cvPrint}
    \dl{
      \cvEntry{2000--2001}{CFC d'horloger rhabilleur}{École d'horlogerie}{Petit-Lancy}{
        Récompence : Prix de la Fonation Hans Wilsdorf
      }
    }{

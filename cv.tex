...
{\small
  ...
  \faHome  \hspace{0.2em} {\tt Ch.\ du Nant-Cayla 2 -- CH-1203 \textsc{Genève}}
}
...
\begin{multicols}{2}
  ...
  \dl{% --------------{ Expériences FR }--------------- %
    ...
    \begin{cvPrint}
      ...
      Main developer of the project \texttt{map-x} : interactive mapping and analysis platform for extractive industries in fragile states.
      }
      \cvEntry{11/2014 -- today }{Developer}{Freelance}{Geneva}{%
      Main developer of the project \texttt{AccessMod 5} : modelisation of accessibility to Health Facilities for the World Health Organisation.
      }
       % --------------{ LEBA 2 }--------------- %
  ...
  \begin{multicols}{2}
    ...
    \noindent\begin{tabular}{ll}
      ...
      \score{4}{5} &\texttt{PostGIS (Postgres)} \\
